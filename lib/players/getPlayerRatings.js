...
/**
 * Returns the Solo and Party MMR history of a specified player, and the relevant match ID where it changed.
 ...
 */
function getPlayerRatings(account_id, options) {
...
module.exports = getPlayerRatings
